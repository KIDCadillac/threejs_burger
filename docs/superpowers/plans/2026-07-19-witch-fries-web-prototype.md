...
**Status:** Completed on 2026-07-19. Automated integration coverage and two-tab mobile browser acceptance are recorded in the repository history and `README.md`.
...
- [x] **Step 1: Write the failing health and page tests**
...
- [x] **Step 2: Install dependencies and verify the tests fail**
...
- [x] **Step 3: Add the minimal application shell**
...
- [x] **Step 1: Write failing tests for setup, safe picks, hits, self-removal, shared poison, draw, and rematch**
...
- [x] **Step 3: Implement focused domain types and transitions**
...
- [x] **Step 1: Write failing queue and room tests**
...
- [x] **Step 5: Commit multiplayer services**
...
- [x] **Step 1: Write failing privacy and socket tests**
...
- [x] **Step 3: Implement command parsing and permission-safe views**
...
- [x] **Step 1: Add a client smoke assertion**
...
- [x] **Step 2: Run the smoke test to verify failure**
...
- [x] **Step 3: Implement the shell, navigation, and transport**
...
- [x] **Step 4: Implement the responsive visual foundation**
...
- [x] **Step 5: Run automated tests and commit**
...
- [x] **Step 1: Add static effect contract tests**
...
- [x] **Step 2: Run the effect contract test to verify failure**

Run: `python -m pytest tests/test_app.py -q`

Expected: failure because the effect module and private-state label are absent.

- [x] **Step 3: Implement mixing and turn rendering**
...
- [x] **Step 4: Implement distinct reaction presentations**
...
- [x] **Step 1: Write failing timeout and reconnect tests**
...
- [x] **Step 3: Implement server timers and disconnect lifecycle**
...
- [x] **Step 4: Surface lifecycle state in the client**
...
- [x] **Step 1: Write exact launch and acceptance instructions**
...
- [x] **Step 3: Start the server and run browser acceptance**
...
- [x] **Step 4: Check repository quality**
