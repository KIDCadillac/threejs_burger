...
- 食材放下后立即退场，不会常驻遮挡汉堡。
- 调料瓶按下时右手出现；瓶子移动、倾斜和挤酱期间，手按瓶身的 3D 投影坐标逐帧跟随；松手后约 220 ms 退场。
...
2. 调料瓶已经逐帧绑定到右手；普通食材仍按“拿取 / 搬运 / 放置”事件切姿态，还不是逐帧绑定到 3D 食材的手腕 IK。
3. 主页 UI 编辑器仍保留旧餐车时代的若干专用分组和时间轴命名；正常主页不受影响，但后续应把编辑器分类改成“旋转料理 / 主题切换 / 玩法区”。
4. 旧木偶厨师与餐车素材仍在 `art/` 里供历史恢复，但新主页和第一人称料理页不再加载它们。

## 推荐下一步

下一步把同一套 3D 投影跟随扩展到普通食材的短程轨迹，仍保持现在的小尺寸和快速退场。不要再加人物身体或长手臂。
