...
1. 在左侧展开“整车与镜头”“出餐窗口与招牌”“菜单灯箱”“底部导航”等分类，或直接搜索。
2. 点击分类中的元素，也可以直接点击中间画布。
3. 使用 Moveable 蓝色手柄拖拽、改尺寸和旋转。
4. Theatre 右侧属性面板会自动切到同一个对象。
5. `layout` 里调整 X、Y、宽高、缩放、旋转、层级、透明度、显示和锁定。
6. `style` 里调整亮度、饱和度、模糊、圆角、背景和文字颜色。
