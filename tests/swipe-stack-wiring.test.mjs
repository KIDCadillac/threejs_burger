...
test("homepage exposes swipe-stack without replacing free cooking", async () => {
  ...
  assert.match(lobby, /mode\.action === "swipe-stack"[\s\S]*swipe-stack\.html/);
});
